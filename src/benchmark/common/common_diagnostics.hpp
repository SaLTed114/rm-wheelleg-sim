...
public:
    ...
    [[nodiscard]] double wheel_contact_ratio(int side) const;
    [[nodiscard]] double minimum_wheel_normal_force(int side) const;
...
private:
    ...
    std::array<std::size_t, BC_SIDE_NUM> wheel_contact_count_{};
    std::array<double, BC_SIDE_NUM> minimum_wheel_normal_force_{{
